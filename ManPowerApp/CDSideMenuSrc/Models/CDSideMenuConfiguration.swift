...
public class CDSideMenuConfiguration: ObservableObject {
    ...
    public init(navigationBarHidden: Bool = false, accountViewHidden: Bool,
                menuBackgroundColor: Color = .cdOffWhite, menuForegroundColor: Color = .cdOffWhite, viewsBackgroundColor: Color = .clear, menuFont: Font = Font.system(.body),  menuButtonSize: CGFloat = 25, menuSizeFactor: CGFloat = 1, openedMenuButtonSFImage: String = "chevron.left", closedMenuButtonSFImage: String = "line.horizontal.3",
